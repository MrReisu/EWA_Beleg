...
type LayoutRouteId = RouteId | "/" | "/admin" | "/admin/inventory" | "/admin/orders" | "/book/[id]" | "/checkout" | "/checkout/[orderId]/cancel" | "/checkout/[orderId]/success" | "/login" | "/logout" | "/search" | "/shopping-cart" | null
type LayoutParams = RouteParams & { id?: string; orderId?: string }
